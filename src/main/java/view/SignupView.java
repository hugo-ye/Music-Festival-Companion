...
/**
 * The View for the Sign up Use Case.
 */
public class SignupView extends JPanel implements PropertyChangeListener {
    ...
    public SignupView(SignupViewModel signupViewModel, LoginViewModel loginViewModel, ViewManagerModel viewManagerModel) {
        ...
        // Title
        final JLabel titleLabel = new JLabel("Create Account");
        ...
        gbc.gridy = 3;
        fieldsPanel.add(passwordInputField, gbc);

        // Repeat Password
        final JLabel repeatLabel = new JLabel("Repeat Password");
        ViewStyle.applyLabelStyle(repeatLabel);
        ViewStyle.applyTextFieldStyle(repeatPasswordInputField);

        gbc.gridy = 4;
        fieldsPanel.add(repeatLabel, gbc);
        gbc.gridy = 5;
        fieldsPanel.add(repeatPasswordInputField, gbc);
